...
import org.jhipster.store.repository.search.CustomerSearchRepository;
import org.jhipster.store.service.dto.CustomerDTO;
import org.jhipster.store.service.mapper.CustomerMapper;
...
import static org.jhipster.store.web.rest.TestUtil.sameInstant;
...
public class CustomerResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_BUY_DATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_BUY_DATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getBuyDate()).isEqualTo(DEFAULT_BUY_DATE);
        ...
        assertThat(testCustomer.isMale()).isEqualTo(DEFAULT_MALE);
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].buyDate").value(hasItem(sameInstant(DEFAULT_BUY_DATE))))
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.buyDate").value(sameInstant(DEFAULT_BUY_DATE)))
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getBuyDate()).isEqualTo(UPDATED_BUY_DATE);
        ...
        assertThat(testCustomer.isMale()).isEqualTo(UPDATED_MALE);
